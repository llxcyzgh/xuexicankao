...
class IndexController extends Controller
{
    ...
    {
        $str = '人类的大脑有五大方面的功能：感觉的功能、……。目前的神经科学研究对（{{感}}{{觉}}{{的}}{{功}}{{能}}{{、}}{{控}}{{制}}{{运}}{{动}}{{的}}{{功}}{{能}}{{、}}{{记}}{{忆}}{{的}}{{功}}{{能}}{{、}}{{情}}{{感}}{{和}}{{情}}{{绪}}）四种功能已有相当深入的了解。';
        $temp   = explode('{{', $str, 2);
        $data = [
            'ask'    => str_replace(' ', '', isset($temp[0]) ? htmlentities($temp[0]) : ''),
...
EOD;
        ...
        foreach ($arr as $key => $value) {
            ...
            $data[] = [
                'ask'    => str_replace(' ', '', isset($temp[0]) ? htmlentities($temp[0]) : ''),
                'answer' => substr(str_replace(' ', '', isset($temp[1]) ? htmlentities(str_replace('}}', '', str_replace('{{', '', $temp[1]))) : ''), 0, 80),
                'type'   => 'challenges',
            ];
        }
